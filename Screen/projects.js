  ...
  return (
    ...
    shadowOpacity: 1,}}
          onChangeText={(searching) => {
            const url =
              'https://dsms0-7e9f.restdb.io/rest/data-scientist-projects?q={ "project_name": {"$regex" :"' +
              searching +
              '"}}';
          ...
          placeholder="Search For a Project . ."></TextInput>
            ...
            >
              ...
              <TouchableOpacity style={styles.flatlistusersR}      onPress={() => {
                ...
                async function del() {
                  ...
                  if (req.ok) {
                    alert('The Project ' + item.project_name + ' Deleted');
                  }
                }
              }}>
